...
- 푸시·배포 ✅ 2026-09-17 — 원장 「진행 ok」 후 푸시(60944112·3b876050·62e21037), Vercel 프로덕션 READY(www.lidamipedu.com, 커밋 62e21037 확인). 공개 캘린더는 비-staff 차단 게이트(lidamedu.com 으로 302)라 운영 확인은 staff 로그인으로만 가능.
- **남은 일(원장)**: 기존 일정 6건의 구분(1차/2차)을 /admin/lecture-schedules 수정 폼에서 지정. 지정 전에는 1차·2차 칩이 빈 상태이고 「전체」에서만 보인다.
