...
> 상태: ✅ 전 항목 완료·푸시(2026-06-19) · 점검 근거 `docs/survey/과제-점검.md`
> 커밋: ①가 773a2c3 · ①나 51d7f8b · ⑥ 263cc0f · ④ 610ced8 · 운영자 지각 배지(후속). 전부 푸시.
> 결정: ①=(나)+(가) / ⑥=학생 상세만 / ④=3유형(recommended·late_allowed·strict). 운영자 진척표 지각 배지까지 반영.
