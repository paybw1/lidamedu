...
> 상태: 🟢 ①⑥④ 구현 완료(2026-06-19) · 점검 근거 `docs/survey/과제-점검.md`
> 커밋: ①가 773a2c3 + ①나 51d7f8b(푸시됨) · ⑥ 263cc0f(푸시됨) · ④ 마이그(20260619, 운영 적용)+코드.
> 결정: ①=(나)+(가) / ⑥=학생 상세만 / ④=3유형(recommended·late_allowed·strict).
> 잔여(소): 운영자 진척표(admin-cohort-assignments) 멤버별 "지각 완료" 배지 — 학생 상세엔 반영, 강사 표는 후속.
