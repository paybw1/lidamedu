...
export const EXAM_INFO_DEFAULT: ExamInfoData = {
  intro:
    "산업재산권 분야 유일의 국가전문자격. 1차(객관식)·2차(논술)로 치러지며, 아래는 2026년(제63회) 시행 기준 요약입니다.",
  schedule: [
    {
      title: "제1차 시험",
      kind: "객관식 5지선다",
  ...
  englishNote:
    "※ 응시원서 접수마감일(2026. 1. 16.)부터 거꾸로 2년 이내에 실시된 정기시험 성적만 인정되며, 제1차 시험 시행일 전까지 기준점수 충족이 확인되어야 합니다. 청각장애인 등 별도 기준은 공식 공고를 확인하세요.",
  stats: [
    { value: "3,541명", label: "제62회(2025) 제1차 응시" },
    { value: "661명", label: "제62회(2025) 제1차 합격" },
    { value: "18.66%", label: "제62회(2025) 제1차 합격률" },
  ],
  source:
