// 빈칸·암기 통계 탭 (4 sub-tab: 내용/주체/시기/암기).
// /study/stats 페이지의 "빈칸·암기" 탭과 redirect 되기 전 /study/blanks 가 모두 사용한다.
...
import type { UserRecitationStats } from "~/features/recitation/queries.server";

export interface BlankStatsTabsProps {
  content: UserBlankStats;
  subject: UserAutoBlankStats;
  period: UserAutoBlankStats;
  recitation: UserRecitationStats;
}

export function BlankStatsTabs({
  content,
  subject,
  period,
  recitation,
