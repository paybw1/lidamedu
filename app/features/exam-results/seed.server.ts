...
const STUDY_SUMMARIES = [
  "기출 회독을 핵심으로 잡았고, 약점 단원은 정오문제까지 별도로 돌렸어요. 매일 아침 1시간씩 조문 통독 → 점심 후 문제 → 저녁 약점 복습 루틴이 흔들리지 않게 유지한 게 가장 컸습니다.",
  ...
  "처음 6개월은 인풋(강의·조문 통독), 다음 6개월은 아웃풋(문제·기출·모의)으로 속도를 나눴어요. 아웃풋 단계로 넘어가니 효율이 확실히 올라갑니다.",
