...
const ITEMS = [
  ...
  },
  {
    ...
    a: "무료회원은 커뮤니티(반별 게시판 제외), 최근 판례·법령 개정 피드, 1·2차 기출 색인, 공지·스터디 모집을 평생 이용할 수 있습니다. 가입 후 15일간은 특허법 학습과목을 무료로 체험합니다. 조문·판례·문제 본문 학습과 오답노트·하이라이트·코멘트·맞춤 퀴즈·학습관리는 자기학습(필요한 과목만 결제)부터, 1차 모의고사·커리큘럼·강사 첨삭·1:1 상담은 종합반에서 제공됩니다. (2차 모의고사·온라인 GS는 별도 프로그램)",
  },
  {
    q: "학원 종합반은 자기주도 구독과 어떻게 다른가요?",
    a: "종합반은 학원이 짠 N주 커리큘럼이 반 단위로 적용되어 자동 주간 과제·강사 첨삭·1차 모의고사·반 진도 관리까지 포함됩니다. 자기학습(과목별 결제)은 본인 페이스로 조문·판례·문제 학습과 합격자 데이터 비교 컨설팅을 이용하는 분께 적합합니다. (2차 모의고사·온라인 GS는 별도 프로그램)",
  },
  {
    q: "자연과학 4과목도 다루나요?",
