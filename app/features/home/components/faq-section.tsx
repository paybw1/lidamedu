...
const ITEMS = [
  ...
  },
  {
    ...
    a: "무료 회원은 최근 판례·법령 개정 피드, 1·2차 기출 색인, 논문·도서 추록 색인, 커뮤니티·공지·스터디 모집을 평생 이용할 수 있습니다. 조문·판례·문제 본문 학습과 오답노트·하이라이트·메모·맞춤 퀴즈는 정회원(자기주도)부터, 진도·합격 진단·1·2차 모의고사·커리큘럼·강사 첨삭은 종합반에서 제공됩니다.",
  },
  {
    q: "학원 종합반은 자기주도 구독과 어떻게 다른가요?",
    a: "종합반은 학원이 짠 N주 커리큘럼이 cohort 단위로 적용되어 자동 주간 과제·강사 첨삭·온라인 GS 채점·반 진도 관리까지 포함됩니다. 자기주도 구독은 본인 페이스로 합격자 데이터 비교 컨설팅만 이용하는 분께 적합합니다.",
  },
  {
    q: "자연과학 4과목도 다루나요?",
