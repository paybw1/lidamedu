...
const ITEMS = [
  ...
  },
  {
    ...
    a: "종합반은 학원이 짠 커리큘럼이 반 단위로 적용되어 주간 과제·1차 모의고사·반 진도 관리·1:1 상담까지 포함됩니다. 자기학습은 본인 페이스로 필요한 과목만 학습하는 분께 적합합니다. (2차 모의고사는 별도 프로그램)",
  },
  {
    q: "요금제는 어떻게 구성되어 있나요?",
  ...
  },
  {
    ...
    a: "토스페이먼츠 카드 결제로 진행되며, 동의하신 경우 매월 같은 날 자동 결제로 갱신됩니다. 결제 후 3일이 지나면 본인 계정에서 자동 갱신을 해지할 수 있고, 3일 이내에는 전액 환불 대상이라 고객센터로 신청해 주시면 처리해 드립니다.",
  },
  {
    q: "환불 규정은 어떻게 되나요?",
    a: "결제 후 3일 이내에 고객센터로 신청하시면 전액 환불해 드리며, 환불이 완료되는 때에 구독이 종료됩니다. 3일이 지난 뒤에는 본인 계정에서 정기결제를 해지할 수 있고, 다음 갱신부터 청구가 중단되며 이미 결제한 기간은 만료일까지 이용하실 수 있습니다.",
  },
  {
