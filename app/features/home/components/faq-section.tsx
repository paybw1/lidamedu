...
const ITEMS = [
  ...
  },
  {
    ...
    a: "무료회원은 커뮤니티(반별 게시판 제외), 최근 판례·법령 개정 피드, 1·2차 기출 색인, 공지·스터디 모집을 평생 이용할 수 있습니다. 가입 후 15일간은 특허법 학습과목을 무료로 체험할 수 있습니다.",
  },
  {
    q: "어떤 과목을 다루나요?",
  ...
  {
    q: "자연과학 4과목도 다루나요?",
    a: "네, 변리사 1차 자연과학 4과목(물리·화학·생물·지구과학)은 모두 필수 응시 과목입니다 — 총 40문제 중 과목별 10문제씩 출제됩니다. 4과목 모두 객관식 문제 중심으로 제공하며, 법률 과목과 동일한 학습 흐름·진도 추적·오답노트가 적용됩니다.",
  },
  {
    q: "학원 종합반은 자기학습과 어떻게 다른가요?",
    a: "종합반은 학원이 짠 커리큘럼이 반 단위로 적용되어 주간 과제·강사 첨삭·1차 모의고사·반 진도 관리·1:1 상담까지 포함됩니다. 자기학습은 본인 페이스로 필요한 과목만 학습하는 분께 적합합니다. (2차 모의고사·온라인 GS는 별도 프로그램)",
  },
  {
    q: "요금제는 어떻게 구성되어 있나요?",
  ...
  },
  {
    ...
    a: "강사진이 개정 시행 시점에 맞춰 반영하며, 즐겨찾기·메모한 조문이 개정되면 자동 알림과 주간 리포트로 안내합니다.",
  },
  {
    q: "질문은 어떻게 하나요?",
