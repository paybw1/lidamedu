...
const COMPARE_AXES: AxisDef[] = [
  {
    ...
    lbl: "분석 합격자 풀",
    desc: "합격증 인증 + 분석 동의한 합격자만 익명으로 집계합니다.",
  },
  {
    Icon: ClockIcon,
    fg: "#10A37F",
    ...
    lbl: "학습 시간",
    desc: "응시 전년~당해 누적 시간을 합격자 평균과 대조합니다.",
  },
  {
    Icon: PencilLineIcon,
    fg: "#7B6BA0",
...
const FEATURES = [
  {
    t: "평균 대비 비교",
    d: "본인 학습이 합격자 평균과 얼마나 가까운지 분위와 차이로 확인합니다.",
  },
  {
    t: "자동 추천 액션",
    d: "다음 한 주에 무엇을 풀고 어떤 단원을 복습할지 자동으로 제안합니다.",
  },
  {
    t: "12주 학습 곡선",
    d: "합격자 분포 위에 본인 곡선을 겹쳐 보고, 위험 신호를 알려 드립니다.",
  },
];
