...
const CARDS = [
  {
    n: "01",
    t: "메뉴 진입 트리",
    d: "과목 → 조문 · 판례 · 문제로 자연스럽게 깊이 들어갑니다. 클릭 한 번으로 도달할 수 있는 학습 단위.",
  },
  {
    n: "02",
    t: "조문 ↔ 판례 ↔ 문제",
    d: "어떤 화면에서 진입하든 관련 자료가 곁에 있습니다. 끊김 없이 잇고, 흐름을 잃지 않게.",
  },
  {
    n: "03",
    t: "최신 정보 자동 추적",
    d: "법 개정, 신규 판례, 신규 문제, 논문이 한 곳에 자동 집계됩니다. 매일 무엇이 새로 올라왔는지 한 눈에.",
  },
  {
    n: "04",
    t: "과목 특성별 학습 구조",
    d: "법률 과목은 조문·판례·문제 3탭, 자연과학은 문제 중심. 같은 시간을 들여도 결이 맞는 학습.",
  },
];
