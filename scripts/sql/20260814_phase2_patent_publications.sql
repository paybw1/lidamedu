-- ============================================================
-- errata Phase 2 (특허 한정) — 판본·매핑 시드
-- 근거: 설계 v1.1 §3.3~3.4 + 결정서 v1.2.1 §7.1 + phase2-patent-matching.md
-- 스코프: 특허법만 (상표·디자인 추후, 민법·자연과학 제외 — 사용자 지시)
-- 적용: node scripts/run-prod-sql.mjs scripts/sql/20260814_phase2_patent_publications.sql
-- ============================================================
begin;
...
create table publication_editions (
  ...
  -- 결정서 §7.1 — 시험일 기준 분류. 확정 전에는 estimate 만 채우고 판정에 쓰지 않는다.
...
-- RLS — 운영 데이터. staff 읽기/쓰기. 수험생 노출은 Phase 4 에서 별도 정책.
...
-- ── 2. 특허 4종 시드 (2026년판 baseline — 현재 DB 가 곧 스냅샷, frozen) ──
...
with ins as (
  insert into publication_editions
    (publication_id, edition_label, edition_seq, target_exam_year, target_exam_date_estimate, frozen_at, isbn, status)
  select p.publication_id,
         v.label, v.seq, 2027, date '2027-02-26', now(), v.isbn, 'frozen'
  from (values
    ('statute',  '제5판',  5::numeric,  '9791124561072'),
    ('precedent','제10판', 10::numeric, '9791124561270'),
    ('mcq1',     '제20판', 20::numeric, '9791199812222'),
    ('mcq2',     '제20판', 20::numeric, '9791199812246')
  ) as v(slug, label, seq, isbn)
...
-- ── 3. content_map 시드 ──
-- 3a. 조문 (조문정리 제5판 목차 — 페이지·toc_path·수록 순서)
...
-- 3b. 판례 (판례 제10판 — 수록 순번. cases.source_seq(제9판)는 비파괴 보존)
insert into publication_content_map (edition_id, content_type, content_id, sort_key)
select (select edition_id from p2_pub where slug='precedent'), v.ct, v.cid, v.sk
from (values
  ('precedent', '1dea17c6-137b-48bc-876c-ab305b696394', 1),
  ('precedent', '2599e979-e6fd-4222-8dc5-57243b00fdcc', 2),
  ('precedent', '32cc31ea-8237-4662-a87a-b16310ff47ba', 3),
  ('precedent', 'c523d98c-70e6-4de6-94f4-3464956d2e1f', 4),
  ('precedent', 'ddf61092-6604-4e20-b413-94f83ce082f0', 5),
  ('precedent', '297f0e80-74e0-4144-9030-cbfca4ea0769', 6),
  ('precedent', 'c1649ded-8bce-4c7c-b232-d96cacb0b3af', 7),
  ('precedent', '73372780-490a-4dc4-a03f-b121c92ab233', 8),
  ('precedent', 'd3f0a2e1-afe9-4848-81f9-ce0c1976af55', 9),
  ('precedent', '26cbcb1e-d4f0-4448-a7bc-ea786b51a6a8', 10),
  ('precedent', 'e94edfd2-59cc-43a8-9334-db802e374fdf', 11),
  ('precedent', 'e4b84e58-a95a-44a7-b05e-9896b297df4b', 12),
  ('precedent', '36dacecd-5879-4f64-9159-11bbf69182a3', 13),
  ('precedent', 'dfbaf61a-2e25-4ea3-93c7-eeb788f5de41', 14),
  ('precedent', '7a145049-3e2e-4cc9-a8a0-778f5dc24335', 15),
  ('precedent', '34b6b037-5cac-45eb-9538-2671e49cdc1f', 16),
  ('precedent', '22353bb4-c44a-4152-bd53-0d4ebaaf43fb', 17),
  ('precedent', 'f7ee2333-b0a8-4a1c-8275-2c6522d70d44', 18),
  ('precedent', '266d96bc-72ea-49f5-af85-56c08f517abc', 19),
  ('precedent', 'cc57234e-9149-4ff3-832f-9a9982e47b03', 20),
  ('precedent', '4364f70f-2338-4292-9529-412bcd429d40', 21),
  ('precedent', '884c68d3-4360-47b9-92db-8c3e9da3baf9', 22),
  ('precedent', '8e84fc20-6def-473a-8639-545708257d6a', 23),
  ('precedent', 'f92ab0e1-3972-462f-893d-a370de3fcd09', 24),
  ('precedent', '9d983694-2cb1-47a1-ac43-cdbba3d14df8', 25),
  ('precedent', 'f39f5d0d-08f3-4918-bcc8-8c989883fe55', 26),
  ('precedent', 'd14beb85-7d89-4987-b8a5-a290d6d75426', 27),
  ('precedent', 'd7201fc1-54d2-43a1-9f8e-645b5c213729', 28),
  ('precedent', '04344d41-357f-4cce-946b-43e5bd33c891', 29),
  ('precedent', '64ef0001-3c68-4bd0-bb77-aec99c2cc8da', 30),
  ('precedent', 'f2753f66-6bca-4808-8c37-a409dd0a7fdd', 31),
  ('precedent', '61742435-6df8-45f9-9cfb-3d3bdb786135', 32),
  ('precedent', 'df4a8631-cbdd-4d23-916a-6550f81a294a', 33),
  ('precedent', '5e4e6732-c52c-47e6-942b-462b14fbf8ff', 34),
  ('precedent', '7b821bcd-ac78-4772-91bf-363991039e82', 35),
  ('precedent', '5eab1ed7-dcf5-4a2d-9679-b147fb6a6130', 36),
  ('precedent', 'a2f50212-ba1a-4dc4-8dac-100f7ceaa791', 37),
  ('precedent', '031f45f6-4dd4-4091-a506-30dd793d09cb', 38),
  ('precedent', '528f72b4-91cc-4195-9573-da74e1790cbe', 39),
  ('precedent', '1d890e2c-0c76-4176-b4b1-c1d2037236ed', 40),
  ('precedent', 'fe77dd49-98ba-447b-825c-b89e3713a273', 41),
  ('precedent', '882a7ab3-9147-49c4-abb6-39cda3157e39', 42),
  ('precedent', '4bd0f1a6-9976-433d-81f0-68c8210fc993', 43),
  ('precedent', '76a006de-74bc-4cee-a317-8b8b687459ea', 44),
  ('precedent', '9b51d038-59a0-4ddd-bca3-836d7dde9d3a', 45),
  ('precedent', '1894456a-74e9-4d51-b905-46a144a12611', 46),
  ('precedent', '576c47ef-bac6-43c1-ab4c-006e02981b5c', 47),
  ('precedent', '7d4ccf96-62a6-462f-b7ab-78dbdc6b9f0d', 48),
  ('precedent', '4bbd7047-748f-4037-9dfa-591b5884661e', 49),
  ('precedent', 'ac392606-36f6-4b47-8819-9079fb52a272', 50),
  ('precedent', '88093d8b-35b0-4358-a978-e52564f00103', 51),
  ('precedent', '4de33dcb-ce74-4b15-bb5f-53cd505a3f0a', 52),
  ('precedent', '306cfa47-d171-49db-a8db-491f3278c8ab', 53),
  ('precedent', '5bb4ee9c-b6fc-4187-b39c-a63bb26e1db3', 54),
  ('precedent', '1d82ab2d-b0b9-4397-aee2-49af85606cc4', 55),
  ('precedent', '9528a1e1-1048-498b-a710-3a71cb29f487', 56),
  ('precedent', '7fe522ab-ca2a-4812-97b8-05866d70e1fe', 57),
  ('precedent', 'ea28ca39-3524-4eab-907d-43c1f3b1a214', 58),
  ('precedent', '32f1e239-3736-42c6-b664-7bb7bbedfabf', 59),
  ('precedent', 'e3fff720-1e37-423c-8b56-30bc63cc34f9', 60),
  ('precedent', 'bb958180-825a-4942-810a-a557853f121f', 61),
  ('precedent', 'beb5df3b-6e9a-4016-b6f2-211a21dcc612', 62),
  ('precedent', 'a5b7a6de-fe58-4ab5-a00d-4e187d1ea4fb', 63),
  ('precedent', '80a122c2-805e-456e-b6b8-759ab953bd72', 64),
  ('precedent', '11b78dd2-e5ff-447d-9476-ec985fd27c96', 65),
  ('precedent', '19c328b6-fa0e-4bd2-9d88-89c049db31d0', 66),
  ('precedent', 'c8f9275e-02ee-45c0-9d8f-1a7434b19e8b', 67),
  ('precedent', 'e02e812b-0306-4fd7-9874-3ee5941a6bcd', 68),
  ('precedent', 'bcf4a21c-3ac3-4b4f-bdea-4f9401fa86ca', 69),
  ('precedent', '693c924d-f139-4800-a3cc-ae33a90e408b', 70),
  ('precedent', '68c4b3bd-1840-4768-b502-2491093950af', 71),
  ('precedent', '47d4960f-b803-4538-87cc-ff3d5f00d5c7', 72),
  ('precedent', 'a144846f-880c-4fb1-b4a9-3e651b70eaad', 73),
  ('precedent', '20ba14fa-caf5-4502-a57c-478f8af4f3b5', 74),
  ('precedent', '13a7991e-8069-4ff9-a2e9-edd0ad3923fa', 75),
  ('precedent', 'ee370afd-c362-4086-bd3e-2fc48c1f1e4f', 76),
  ('precedent', 'bba782dc-e424-4eaa-b18a-e1581ac149c3', 77),
  ('precedent', '9d5116d1-3000-466f-9fac-8344b746ebfe', 78),
  ('precedent', '008eb791-7e5f-4aaa-b30f-f90f2f9973a1', 79),
  ('precedent', 'ea96aac5-d790-43be-91ae-cefe86857cd3', 80),
  ('precedent', '58779b27-7d49-4057-9c40-04735c3007dc', 81),
  ('precedent', 'b018db9c-e64e-45c2-b367-68242a03f653', 82),
  ('precedent', '248a2e2f-748d-4189-a372-8ff897956ec6', 83),
  ('precedent', '03a1eeeb-25a1-461e-b8be-5962bf1cfcbc', 84),
  ('precedent', '6d8fc7d5-fb4f-4232-b19d-c96bf95ca3f7', 85),
  ('precedent', '2f0c7fa8-ebea-4f4d-aeaa-a32166efb606', 86),
  ('precedent', 'c34a7666-65d5-456e-8d30-6b26b9d35599', 87),
  ('precedent', '8c541239-625d-4af6-994f-71c7b89f494b', 88),
  ('precedent', 'e1dc5bcc-5bf0-4819-9395-c43e9e9203ca', 89),
  ('precedent', '9f8a8690-24bd-4a27-a000-d37aab444ad6', 90),
  ('precedent', '9a4edad4-c705-4c0d-ba73-d22c0c5d54b4', 91),
  ('precedent', '97c12c25-6939-431c-b56c-cef369fa8804', 92),
  ('precedent', '0425bd00-cbea-481c-836c-e39c9c1b510d', 93),
  ('precedent', '66af5c34-8622-4243-adfb-28c94cf02c51', 94),
  ('precedent', '36bcf08a-3bd1-4c03-8a32-32b0fd7fb4fe', 95),
  ('precedent', '1fad6641-c665-4da9-8685-e56d4436f90f', 96),
  ('precedent', 'c6a8a29c-17e4-4a8d-b4dc-639250b83a8b', 97),
  ('precedent', '078eb69d-057f-46ee-bc71-02784904e130', 98),
  ('precedent', 'f9d70c04-c7e3-4dac-a093-8771b6f22108', 99),
  ('precedent', '1834cb90-2aa5-47c8-b9d3-242dfabc3a6a', 100),
  ('precedent', '19932e5b-1647-489d-808e-9476e522f4fe', 101),
  ('precedent', 'd7691a82-d182-42f1-b5e6-961641e2853e', 102),
  ('precedent', 'e4af6554-4665-4531-b0ea-77a0175c761c', 103),
  ('precedent', 'd633fbf1-fefe-4453-9cf5-ad252a1aff88', 104),
  ('precedent', 'a910bc99-79bf-4d51-8e6f-25b27cea98a4', 105),
  ('precedent', 'da2724f1-5756-4254-8d5f-24f7d5fe0b1c', 106),
  ('precedent', '15c60a39-3363-4b4b-9e91-1bff49285593', 107),
  ('precedent', '250d2ed0-08b6-4da5-972f-078fc71a7de7', 108),
  ('precedent', '98a481f2-135c-468c-a138-0c30edd8a298', 109),
  ('precedent', '3e29bf45-f937-4426-a91d-0ae25a6bb435', 110),
  ('precedent', '571f7eeb-927b-4bf3-a24e-80fea044a311', 111),
  ('precedent', 'f6d74d31-fabb-4e59-9bfc-ea0ec95b3a76', 112),
  ('precedent', '0dfe5d27-8d8f-4aec-8d12-b1fd24a92198', 113),
  ('precedent', 'eb1e4841-879b-4f4c-a801-55daeb24ace0', 114),
  ('precedent', '3c630754-2e20-4098-8c88-5a608043446d', 115),
  ('precedent', 'eb33eed0-1628-495f-825d-4063df2f9979', 116),
  ('precedent', 'e772b06c-0ec2-4f28-af32-ee0a79e6879a', 117),
  ('precedent', '40225ebf-37f4-48b4-8bed-646f3446f11d', 118),
  ('precedent', 'e20dfcb5-eb8b-44ba-b846-1c475f171bf5', 119),
  ('precedent', '3b1dc991-0694-43b7-8f1c-1a34a9475688', 120),
  ('precedent', '0df48276-a097-482b-b12a-095ff0b58165', 121),
  ('precedent', '56b56f56-485f-4503-a53c-bbc5a499edd6', 122),
  ('precedent', 'b5d88a00-2cd0-4897-971d-530aa9e2b890', 123),
  ('precedent', 'd878e24d-cb3b-44f8-8dba-7fc40f3dddb3', 124),
  ('precedent', '150756d6-9d11-42fc-afe6-8c60543c558f', 125),
  ('precedent', '05e2cb5d-c214-45b0-96f7-fb4b9ace6990', 126),
  ('precedent', 'a6d71a64-b000-4aec-be9d-0133649fb638', 127),
  ('precedent', 'ada3cfed-6ade-43e9-9ba7-492f7a683ec0', 128),
  ('precedent', '08ffa4c3-39f6-40d5-953f-d4e52ece0f86', 129),
  ('precedent', 'fd6bf315-c153-4724-b2a0-9fcb99363982', 130),
  ('precedent', '1841e948-2183-4e6c-913e-3cd34833d78d', 131),
  ('precedent', '80748b53-42cd-474f-b504-198f9ef15277', 132),
  ('precedent', '94a1f9bc-7808-41cd-b9cb-2baa5d62c92e', 133),
  ('precedent', 'dab2a1f6-da5f-4183-bb42-ea951faeb788', 134),
  ('precedent', 'd945b2d1-3d5a-4a04-8574-eb549a5331e2', 135),
  ('precedent', '8b9095ba-f094-4f77-b9df-217a7e0b3f25', 136),
  ('precedent', 'd877d41c-be58-4a64-9c64-6a91ddef31ad', 137),
  ('precedent', '07b4fe01-1476-4953-967b-2103677fd563', 138),
  ('precedent', 'f7d4b578-9c91-4f22-bd8a-060e106cc467', 139),
  ('precedent', '7c4a34cb-c6ee-4f04-b6fa-c6bbdf2dbb56', 140),
  ('precedent', '33544cbc-9232-4bec-bf58-12eefc4109ed', 141),
  ('precedent', '720435a1-3242-46e1-8768-fda23dd95eda', 142),
  ('precedent', 'd08c1d0c-d95d-4db9-af14-837a6f5cd492', 143),
  ('precedent', '72cd5483-ae30-47fd-8b45-51bc3b149a42', 144),
  ('precedent', '859258d6-d0f3-4d32-8830-8a343eb34a7d', 145),
  ('precedent', '675c9ad0-1075-4187-b7c0-47ca1ba26723', 146),
  ('precedent', 'ad294091-f91f-46b8-9319-886f0327e1db', 147),
  ('precedent', 'd40c92db-bb34-4446-8ad8-958c3314f1da', 148),
  ('precedent', '391872b7-83ad-489d-b58a-00f64cf5f1a1', 149),
  ('precedent', 'e57b59d1-e7e8-4ccc-a1a9-cfcc932a6724', 150),
  ('precedent', '7d20350f-0c6c-485c-9e13-ddd244d1ce68', 151),
  ('precedent', 'c4ba77e9-bfdf-4665-b0bd-09b5694ac659', 152),
  ('precedent', '68ef7890-e95a-4839-9736-38ee2f0359c5', 153),
  ('precedent', '415f7e2e-a1f6-4535-9dc7-65fbcca699db', 154),
  ('precedent', '009c21c9-dc0c-47db-b868-900015b3da66', 155),
  ('precedent', 'b271bf42-f5fd-49a7-adac-7a1cd7c561ac', 156),
  ('precedent', 'f2a3c282-28c3-4894-a562-b6f0a4bfd607', 158),
  ('precedent', 'f079382e-964b-48e3-a659-383a0a2170fe', 159),
  ('precedent', 'fb7b7864-9ed7-419c-a8a0-46438e965774', 160),
  ('precedent', '241dd682-a587-4213-b16f-229622c38ff9', 161),
  ('precedent', '0269f755-92ff-4615-99a6-5a51ff1ce33f', 162),
  ('precedent', '9b6df754-dd11-4177-9f67-4e14a3ea9e69', 163),
  ('precedent', '1f406488-22e2-46a9-b803-417f3134dd00', 164),
  ('precedent', '66e68921-cb6a-4f8c-b759-c6a6caa3602d', 165),
  ('precedent', '0cbe250c-7595-44ef-85e5-34159c767bc3', 166),
  ('precedent', 'be7146ee-5f31-463a-8e7c-8af2e874eb47', 167),
  ('precedent', '2d54d633-e550-4c06-bca9-4ee05835d6dd', 168),
  ('precedent', '75ab8142-5126-4f7e-ab53-df9eacf539df', 169),
  ('precedent', '4ff21766-2210-4194-b03e-8aff0bd3a67b', 170),
  ('precedent', '4c042a85-92da-4c61-9c19-05fc1d7608dc', 171),
  ('precedent', '539ed1a4-d556-4a31-8d9c-f8f30409efd4', 172),
  ('precedent', 'c97e5d71-5d61-4b5d-a9e0-4c06737b2811', 173),
  ('precedent', '452b450b-5c7d-4d8a-8c9d-f40297747a30', 174),
  ('precedent', 'f34ecaf7-fb8e-4a1e-bb0f-1bf48492c21d', 175),
  ('precedent', '3f82e62e-1e45-402c-97ea-9937ba70a916', 176),
  ('precedent', '4c5bf877-5241-49bd-9ba9-773d48217b31', 177),
  ('precedent', 'dcc71d63-1b59-4002-b58e-a59d8bc1decd', 178),
  ('precedent', '99724bc0-7804-44c6-9729-b2c224398aa0', 179),
  ('precedent', 'a3250a42-3d36-4118-b338-2ad42c8e6a4c', 180),
  ('precedent', 'f97d445a-f142-4d0c-bcec-612672872b5d', 181),
  ('precedent', '8b196575-a9c0-4ce2-a2c7-16d4d0afb6fc', 182),
  ('precedent', '23e1fd4f-6dbc-4b9a-9f06-aa1eb07f5c69', 183),
  ('precedent', 'd3ad0928-7d66-4e3e-bb36-3bcc3e6ed7b2', 184),
  ('precedent', 'f969cf4f-d5b8-4e5b-b85f-37dffdd8645a', 185),
  ('precedent', '99fc5d7b-2abd-4261-8f27-4661d2c6c48e', 186),
  ('precedent', 'd11cc2aa-ab0c-4552-b629-054c838f61d0', 187),
  ('precedent', 'd27579cc-0c1a-438e-b7ea-ce9bb8693a96', 188),
  ('precedent', '6509d947-7ba5-4260-b2ac-a4ff4b54bb55', 189),
  ('precedent', '2dead4f7-ddee-4640-a739-4f2110755592', 190),
  ('precedent', '1fbeca25-4cb3-427c-9326-0a2dd97b52da', 191),
  ('precedent', 'c714950d-b3cc-43ad-a66d-5a11138a68ab', 192),
  ('precedent', 'dc31e0f2-b6f0-472f-ac28-d641807c09aa', 193),
  ('precedent', '3891e6d1-d236-4bcc-b4f8-5d320f15f4d0', 194),
  ('precedent', 'abe99163-8b18-498b-bf97-29d349aca029', 195),
  ('precedent', '1fe024ce-f06e-4cfc-a966-d885375319ae', 196),
  ('precedent', '6c3ad51a-dea6-41db-a487-74cb49711d6a', 197),
  ('precedent', 'e0b162ba-4e97-45b6-9044-a9acb301e6df', 198),
  ('precedent', 'b7f549ca-8f2e-41f8-87f4-c08e46193364', 199),
  ('precedent', '02c81f1e-8cf3-4739-b5fa-f48ab0d7a2e1', 200),
  ('precedent', '37274ff7-c1f2-4bf9-b6ea-0e6047ea3326', 201),
  ('precedent', 'ed3f7653-bad9-4990-bae9-bb3a14507976', 202),
  ('precedent', 'd22416cc-271a-47d6-b29f-6bc2189638e8', 203),
  ('precedent', '8c1acabf-c9d0-4942-aa5a-155d4f276a2a', 204),
  ('precedent', '0a343f76-0988-4b58-864e-c7016eed9db3', 205),
  ('precedent', 'd41e6fc3-8cfe-41b6-9a4d-04f200c803e4', 206),
  ('precedent', 'dd58ec6b-8c74-4447-a4ab-a87a4d423848', 207),
  ('precedent', '1accc744-fb7d-4e4b-9b52-121fef729b45', 208),
  ('precedent', '997b5b11-1949-447b-9f1b-51e796c6a37c', 209),
  ('precedent', '724d3102-fd28-485c-a7b4-776268e2167d', 210),
  ('precedent', 'be41c8f5-ea1a-486d-ba0c-32cb0785747a', 211),
  ('precedent', '2321cf87-c6e8-4feb-8028-8d8a7ec42a97', 212),
  ('precedent', '1299e09b-98e1-42ba-a869-d967317bb2cf', 213),
  ('precedent', '43f6635d-272b-4293-8547-19127094e53a', 214),
  ('precedent', '583b0913-5849-4a0a-8e6c-fa5fa247f5b2', 215),
  ('precedent', '5890a231-852e-47bc-b400-e5483e044560', 216),
  ('precedent', 'c800400a-0333-4ce6-b7e9-34ebd63072ae', 217),
  ('precedent', 'ed74208c-f310-4e6d-a1ae-e85ce4ba7210', 218),
  ('precedent', '7523ab35-fc8f-448e-a4e4-3db6005364b4', 219),
  ('precedent', '3b6210ac-c01e-4c68-8191-9f272fe5a9cb', 220),
  ('precedent', 'b1185412-d3d7-4acc-b90c-13a9e434b818', 221),
  ('precedent', 'f071ca96-1e8f-4d22-b8da-8794713628c4', 222),
  ('precedent', '95ec7811-9398-4aa7-9135-7a264bffa7c4', 223),
  ('precedent', 'b6c088aa-c825-458e-ab2c-1200389e7d69', 224),
  ('precedent', 'e57383a1-f84a-4ae1-b1d7-34e7f8ff3406', 225),
  ('precedent', 'b5e10976-cec8-441f-ad90-f0ef7ec66624', 226),
  ('precedent', '34745e1f-2320-484d-a65f-ca850012ef01', 227),
  ('precedent', '07660455-d2c4-487d-966d-a8b1b0a9caf2', 228),
  ('precedent', '607ce55a-e40d-42f9-a3ce-63b1f2318f48', 229),
  ('precedent', '2c5dd70a-e592-4031-abe8-c739f2071df6', 230),
  ('precedent', '353cf43d-a9c2-4c16-8a78-eb4c77f18fbc', 231),
  ('precedent', '8edff07b-d5f7-43e5-9204-c4c4d685a11f', 232),
  ('precedent', '9221690e-86e6-448d-99f0-4496ba80587c', 233),
  ('precedent', '81043cb8-c0cb-43d5-8e49-1e30c962c42d', 234),
  ('precedent', '977c3c6f-564e-4be4-becd-73b574e99a21', 235),
  ('precedent', 'd7465d15-9cd4-4708-909b-f40350421b96', 236),
  ('precedent', '34ff835d-3321-4158-aa2a-edb6878a0c58', 237),
  ('precedent', 'd096c454-d703-4413-bbe5-47a38e7cac6e', 238),
  ('precedent', 'f341ed82-ebf1-46fe-915c-ae2da9756274', 239),
  ('precedent', '470b6c87-3403-467e-8655-c2f037c0e1e9', 240),
  ('precedent', 'edc91789-02a2-49f9-a036-3401b376b99d', 241),
  ('precedent', 'e205ca9a-9e36-41ef-b4be-54da6976323d', 242),
  ('precedent', '142b7be3-0236-4aa9-91d5-699bd9dad63f', 243),
  ('precedent', '929a0ab0-2066-4a9f-939a-1cca349abea8', 244),
  ('precedent', '81e999e4-71af-46ae-ac00-af8e61356d91', 245),
  ('precedent', '07d0f870-a6f6-4572-abb0-3055f8e99d36', 246),
  ('precedent', '3176d95c-8e4c-4770-b5c2-07edfaac862c', 247),
  ('precedent', 'ad135fe5-6185-4723-b883-3cfab9d9ba75', 248),
  ('precedent', '01615372-c870-4f04-bf1a-bd99d9f3d32e', 249),
  ('precedent', '5a02b9d7-2499-47a2-b23f-c3255a324d66', 250),
  ('precedent', '9d4f504b-6b75-497f-99b6-efd5c3052c32', 251),
  ('precedent', 'd4d60c04-146a-4540-be0c-0e068e81ce7d', 252),
  ('precedent', 'aec73b83-d91b-4353-8a8b-6cd8ff2b901b', 253),
  ('precedent', '59c3d66c-dc0d-4bc6-bca9-98e1d1f3d56f', 254),
  ('precedent', '78f51c36-bf17-4efa-b7be-505891da851b', 255),
  ('precedent', '2c8eb47c-60c1-4602-820d-1c9960afe44a', 256),
  ('precedent', 'ac9094c4-0f4a-4ef1-88b4-0e482af7e7d1', 257),
  ('precedent', 'e6f7b338-a560-4d24-9605-38fc4b6bc0ce', 258),
  ('precedent', 'ecd32f47-2e2e-4271-82eb-d6d6376faa33', 259),
  ('precedent', '21801781-ee0e-424a-b781-5d4eebbc5a87', 260),
  ('precedent', 'e17911d8-c32f-4e91-bd6a-4ac5afb0b2d5', 261),
  ('precedent', 'a802c5eb-d6af-4272-bfc8-585f47b5dea1', 262),
  ('precedent', '818effb9-609e-4856-ac74-9548e47ce633', 263),
  ('precedent', 'aca3c71e-9a3b-4b68-bf2c-50ac755b81ee', 264),
  ('precedent', 'c166000f-38e3-4fe2-9d30-bf1429949ee3', 265),
  ('precedent', '611c8c6f-3f55-4cdd-a2d8-c3d7dd1a0a62', 266),
  ('precedent', 'd4bc2efc-ff91-43c6-b1b2-20c9f6cd3679', 267),
  ('precedent', '45ba85f4-9d33-4b9f-8b7b-06e46365830d', 268),
  ('precedent', '5b7ea685-c8d1-4ab0-b05b-72346a644151', 269),
  ('precedent', 'f020b717-2d08-4db9-9393-ca099deabc1d', 270),
  ('precedent', '28bae150-01be-4951-87f9-c1de2c2fdfb6', 271),
  ('precedent', 'f2e03c88-0d62-499c-9ff2-4eb3d47081c7', 272),
  ('precedent', '56c07a2d-755d-48b2-bdbd-f4addc2c2c3d', 273),
  ('precedent', '8f51e9e1-bfb2-41bb-90bd-8568f3791dbc', 274),
  ('precedent', '4d2e8e06-f48d-4299-920f-87f375037744', 275),
  ('precedent', 'c54caaed-840d-40a0-bdb6-234291c984d5', 276),
  ('precedent', '36cb39d4-84c6-4ad7-8b5f-544af8bbf9f9', 277),
  ('precedent', '26d7a488-baf7-46ed-bcde-0f0fdb624c3c', 278),
  ('precedent', '29afc536-76cd-47b7-83bc-400fddef1f3a', 279),
  ('precedent', '0b3ce7fa-b612-4a7c-aa67-4ff66cf289d6', 280),
  ('precedent', 'a85f4b1b-e893-4cb3-bf9a-055a21818a19', 281),
  ('precedent', 'aeaeb5b0-2a78-4523-9972-0386af5346aa', 282),
  ('precedent', '3a3cfec7-8b90-430a-976a-5f4ea55dff52', 283),
  ('precedent', '24c236b2-30cf-4d79-b990-daea0f5b1cc0', 284),
  ('precedent', 'ff9d4a42-d71b-491b-bf86-4d0529bcc0da', 285),
  ('precedent', '1a35cdc1-d22b-4522-b15b-88e0e7682bb8', 286),
  ('precedent', 'bb8f63ed-f781-4dac-8001-2dfcd8f5a48d', 287),
  ('precedent', 'ca82fc16-73c0-423c-b328-865fc6b370d6', 288),
  ('precedent', 'dd24c0f0-6027-494b-b055-9e49237bdd3f', 289),
  ('precedent', 'd6e16847-2e9b-44c1-93d2-5f794562cc4c', 290),
  ('precedent', 'a81fdc0d-ec5d-4efe-b931-818cf0d10381', 291),
  ('precedent', '6dd50ea5-4d48-4246-8edd-b77d19e2dde7', 292),
  ('precedent', 'c8f135a5-785e-47be-97c2-8d6b3b7c158d', 293),
  ('precedent', 'a9f3d640-e5d0-43b9-b8ed-74cbfe84a8ab', 294),
  ('precedent', 'ad595a6b-9e46-4db8-9fe5-b3c4d45f506b', 295),
  ('precedent', 'c706b220-6bdd-4d70-ba04-ebf80756c865', 296),
  ('precedent', 'd4fe5626-b959-4eb9-bf6a-c0e3d9af844d', 297),
  ('precedent', '92e18d5a-4f11-43f4-992b-89d4f8d7c659', 298),
  ('precedent', '3464fd53-8886-4da0-b089-7a7cd2ba7338', 299),
  ('precedent', 'ae0fb7c9-d8a7-45f5-b446-92ea19a48b67', 300),
  ('precedent', 'c0f9fbc6-1c5d-4634-b542-7ef644a26c4a', 301),
  ('precedent', '8414bb1e-7cd1-450e-99f1-e084eb2791e1', 302),
  ('precedent', '212ab7d9-d9af-42be-99e4-a353e5966085', 303),
  ('precedent', 'fb047442-40e4-40d3-ac6a-b22637a52f4c', 304),
  ('precedent', '070acb3b-8dc2-42f8-b70e-6781f04a91b4', 305),
  ('precedent', 'ce977ec5-9964-46cf-b300-27d621358515', 306),
  ('precedent', '41144bf9-030b-4a35-908a-c91f2c59aefb', 307),
  ('precedent', 'cc6b7d3a-0bf8-4985-9c51-a0b83e796a0f', 308),
  ('precedent', '439da8eb-f15f-4bb4-aa9d-8c7999958223', 309),
  ('precedent', '2c8043cb-4a7b-4217-87f6-9eaa5f10a431', 310),
  ('precedent', 'e92d0c9c-4332-40a8-bc94-a6de103bdd56', 311),
  ('precedent', '0c67c36c-2823-4759-b4dd-b8cd9ab1f083', 312),
  ('precedent', '293692ce-df50-4854-9c68-3cfaa8e23779', 313),
  ('precedent', '9397cb6d-6caf-4d7e-8125-38527e2e85af', 314),
  ('precedent', '4f4b92f9-cfa9-4906-9721-c70455b2ff9b', 315),
  ('precedent', '356a9fb9-f7d0-4471-a11f-7e049e1adf33', 316),
  ('precedent', '0a462717-4311-4127-b266-51db2133d944', 317),
  ('precedent', '14a993d6-85bf-4c44-9a34-cd779e0cba3d', 318),
  ('precedent', '19d6d254-25e4-4ca7-80aa-7e62d5fedcec', 319),
  ('precedent', '997b60bb-baff-493d-ac98-8c2ef4c72dda', 320),
  ('precedent', 'ed521718-170c-4297-81a0-0033fa6fcaa7', 321),
  ('precedent', 'e10be9e3-b26a-4f36-bc3c-54e1a8ad10b3', 322),
  ('precedent', '3be0cec2-3ae6-4a9c-8310-a0afbf6e9e4f', 323),
  ('precedent', 'bf986b63-1e54-4dde-b319-96dff2a2c815', 324),
  ('precedent', '0e9e8075-06d0-4f9e-b894-32edb63a2283', 325),
  ('precedent', '0f106ef6-ffae-4e50-aa25-04f2c797ebc9', 326),
  ('precedent', '98c0aa14-c029-45b4-9fd5-387e0bc0cf5d', 327),
  ('precedent', 'b62dfc5d-bb21-4528-bbca-c2ad94ead69c', 328),
  ('precedent', '61f75cb3-0130-4fc3-b796-aabecd3ab1ca', 329),
  ('precedent', '1a145e14-0c6d-44ed-8d08-54659c6fa4b4', 330),
  ('precedent', 'ebd4cf63-69ae-48e4-af0e-ac0ad8b6ddf1', 331),
  ('precedent', 'ab48f026-04bb-4bef-9c65-020a20d66c98', 332),
  ('precedent', 'e757fec9-8100-46fa-aa11-66af9500894a', 333),
  ('precedent', 'b6b8bbb0-5d63-4f31-bd9e-c69b842edd95', 334),
  ('precedent', '3443f8f0-a59d-4d0c-bdfe-010ca7b29a16', 335),
  ('precedent', '5b6add49-1fca-4cea-878d-4543bfb26d49', 336),
  ('precedent', '0494162c-ce33-4c99-af93-26c2763844ee', 337),
  ('precedent', '89a29e00-7f71-4cde-a668-31c972f79050', 338),
  ('precedent', 'eb7b9ab0-18ec-4a65-ae87-fd256a1de789', 339),
  ('precedent', '6f339935-9904-4138-be10-e79393a1a1ab', 340),
  ('precedent', 'd1f9f207-1057-4dbe-a9c7-2e42baf837f4', 341),
  ('precedent', 'd9f249a3-bebc-4e2c-ab0a-9a0ff0bbf847', 342),
  ('precedent', 'f30c0ddd-44a2-43d6-9439-c0e62f87bda1', 343),
  ('precedent', '58fde2f4-4c64-4748-aec0-827fda66a239', 344),
  ('precedent', '1eea3526-8e78-4857-af40-0929769860db', 345),
  ('precedent', '92df56bb-f64c-4569-a2ce-37429df8d145', 346),
  ('precedent', '8b3583b6-9755-4275-a5ae-9b1b09c0d381', 347),
  ('precedent', '5f32c006-4f2b-4176-aeb1-dfeb05fc3bcc', 348),
  ('precedent', '43848082-540f-49b6-8269-4e0e6b11b3e6', 349),
  ('precedent', '85e56f2c-2c62-4b87-8bbc-d3b9326de50a', 350),
  ('precedent', 'd9871387-1307-4baf-a19a-1e08f863b954', 351),
  ('precedent', '58f96fcc-897b-442e-ab60-28b6a9ce9f1f', 352),
  ('precedent', '42a11bcd-50bc-4ec5-af1c-da4d07052329', 353),
  ('precedent', '0ca35a2a-6d40-42cb-9bb9-0dfec4fb2ea8', 354),
  ('precedent', 'dfad1dd9-a95a-4513-8970-7d1a3a41d251', 355),
  ('precedent', '27197fde-c136-4a0e-be03-14cddc8f2d76', 356),
  ('precedent', 'a74a81f8-d9f3-4be1-8e10-daad753ca642', 357),
  ('precedent', '57fbd7da-d558-45db-ac27-8d0fac362b8f', 358),
  ('precedent', 'a3e489ab-bf81-4d59-b713-e3dbf3561547', 359),
  ('precedent', 'e08ed373-54d6-49f8-99f2-ff386e6ecbab', 360),
  ('precedent', '062a5d7e-14fa-4724-a335-0afd1d1858bf', 361),
  ('precedent', '5f76ed53-b63e-443f-afac-79f18c504bd2', 362)
) as v(ct, cid, sk);
...
-- ── 4. 특허 기출 미연결 3건 백필 (생성 시점 ID 확정) ──
-- ★이 UPDATE 는 content_revisions 원장에 정상 기록된다(내부 수정, notice none).
with fixed as (
  update problems p
...
begin
  ...
  if n <> 361 then raise exception 'precedent % != 361', n; end if;
