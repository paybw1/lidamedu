...
// 반영 전 현재 값을 scripts/mcq-audit/backups/backup-fixes.json 에 저장한다.
...
const TARGETS = [
  { displayNo: 9494, answer: [1], explFrom: ["출원인", 4], why: "정답 ③→① · 선지해설 5개가 2017년 13번(확대된 선출원) 것" },
  { displayNo: 9495, answer: [3], explFrom: ["직무발명", 1], why: "정답 ①→③ · 선지해설 5개가 2018년 5번 것" },
  { displayNo: 6061, answer: [2], explFrom: ["실시권 일반", 5], why: "정답 ⑤→② · 선지⑤ 해설 끝 잔재 제거" },
  { displayNo: 6063, answer: null, explFrom: ["실시권 일반", 7], why: "정답 정상 · 선지 ②③⑤ 해설이 뒤섞임" },
  { displayNo: 7754, answer: [3], explFrom: null, why: "정답 ③⑤→③ (원본은 ③ 단독)" },
];
...
writeFileSync("scripts/mcq-audit/backups/backup-fixes.json", JSON.stringify(backup, null, 1), "utf8");
console.log(`백업 저장: scripts/mcq-audit/backups/backup-fixes.json (${backup.length}문항)\n`);
